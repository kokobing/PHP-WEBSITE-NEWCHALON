...
<div class="maincontent">
    <div class="maincontentbox">
        ...
        <div class="rightcontent">
            ...
            <div class="<?php if($pageid==1){echo aboutcontent;}else{echo aboutcontentb;}?>">
              <p>
              <?php if($pageid=='3'){echo $setinfo[mapcode]; echo "<br><br>";}?>
			  <?=$str[content]?>
              </p>
              <?php if($pageid=='1'){?><div class="aboutpic"><img src="/inc/pics/about_01.jpg" width="330" height="220" border="0"></div><?php }?>
