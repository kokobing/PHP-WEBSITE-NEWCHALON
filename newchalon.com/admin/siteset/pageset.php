...
if(isset($action) && $action=="02" && $onuserperm_addprem=='1'){
	...
	$strSQL="INSERT INTO pageset(title,pagetitle,keywords,description,content,intro,lang)
	                     values('".$_POST[title]."','".$_POST[pagetitle]."','".$_POST[keywords]."','".$_POST[description]."','".$_POST[newscontent]."','".$_POST[intro]."','".$_POST[lang]."')";
...
if(isset($action) && substr($action,0,2)=="04" && $onuserperm_editprem=='1'){
    ...
    $strSQL="UPDATE pageset SET title='".$_POST[title]."',pagetitle='".$_POST[pagetitle]."',keywords='".$_POST[keywords]."',description='".$_POST[description]."',content='".$_POST[newscontent]."',intro='".$_POST[intro]."',lang='".$_POST[lang]."' where id_pageset=$onenewsinfoid";
...
<div id="lineout">
   ...
   $strSQL="SELECT opicname,id_pagesetpic,type,title FROM pagesetpic WHERE id_pageset=$onenewsid ORDER BY ordernum asc ";
   $objDB->Execute($strSQL);
