                    ...
                    <td align="center"><table width="88%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                       ...
                       <? for($j=0;$j<sizeof($arrnewsdir2);$j++){
							if($onuserperm_editprem=='1'){
						?>
  <tr>
    <td><? echo '<span onclick=newsdiredit('.$arrnewsdir2[$j][id_proddir].',"2",'.$onuserperm_deleprem.','.$arrnewsdir2[$j][ordernum].','.$arrnewsdir2[$j][lang].');  style="cursor:pointer;font-size:110%;">'.$arrnewsdir2[$j][name].'</span>';}else{echo $arrnewsdir2[$j][name];}?>
    
    <div style="line-height:25px;"><a href="#" style="float:left;margin-left:15px;text-decoration:none;color:#494949;display:block;">44444</a></div>
