...
//交换位置
  ...
  $newsintro2=$_POST[intro2]; //产品简介
  $newsintro3=$_POST[intro3]; //产品简介
  $newsintro4=$_POST[intro4]; //产品简介
...
$strSQL = "SELECT productinfo.id_prodinfo,productdir.name,productinfo.title,productinfo.content,productinfo.ordernum,productinfo.tag FROM productinfo left join productdir on productinfo.id_proddir=productdir.id_proddir WHERE productinfo.dele='1' $str order by productinfo.ordernum DESC" ;
...
if(isset($action) && substr($action,0,2)=="04" && $onuserperm_editprem=='1'){
    ...
    $strSQL="UPDATE productinfo SET title='$newstitle',content='$newscontent',id_proddir='$select2',modate=now(),intro='$newsintro',intro2='$newsintro2',intro3='$newsintro3',intro4='$newsintro4',tag='$newstag' where id_prodinfo=$oneproductinfoid";
            ...
            <tr>
              ...
              <table width="100%" border="0" cellspacing="3" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="32%" align="left"><a href="product_manage.php?03<?php echo $arrproductinfos[$i][id_prodinfo]?>&searchselect=<?php echo $searchselect;?>&keywords=<?php echo $keywords;?>"  class="txt_leftmenu"><?php echo cutstr($arrproductinfos[$i][title],40,1);?></a></td>
                    <td width="24%" align="left"><?php echo $arrproductinfos[$i][tag];?></td>
            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td ><textarea name="intro" id="intro" style="width:500px" rows="8"><?php echo $oneproductinfo[intro]; ?></textarea>                            </tr>
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td valign="top" bgcolor="#FFFFFF">产品细节</td>
