...
<div class="maincontent">
    <div class="maincontentbox">
        ...
        <div class="rightcontent">
            <div class="grayline" style="color:#333; padding-left:10px; padding-top:5px;"><?=$arrnews[0][name]?></div>
            <div class="abouttitlepic"><img src="/inc/pics/img1.gif" width="690" height="36" border="0"></div>
            
            <div id="newsquery">
              
              <ul>
              <?php for($i=0;$i<sizeof($arrnews);$i++){?>
              <li class="title"><div class="title"><a href="/jp/news/newsview.php?ndir=<?=$_GET[ndir]?>&nid=<?=$arrnews[$i][id_newsinfo]?>" target="_blank"><?=$arrnews[$i][title]?></a><div class="time"><?=$arrnews[$i][newsdate]?></div></div></li>
              <?php }?>
              </ul>
              
              <div id="backbutton"><?php if(substr(trim($strNavigate),-46)!='#494949"><strong>1</strong></font>&nbsp;&nbsp;'){echo $strNavigate;}?></div>
