...
<div class="maincontent">
    <div class="maincontentbox">
        ...
        <div class="rightcontent">
            <div class="grayline">トップページ > 連絡方式</div>
...
<table width="690" border="0" align="center" cellpadding="0" cellspacing="0" id="table13">
            <tr>
              <td height="50" valign="top" bgcolor="#FFFFFF"><table width="632" height="363" border="0" align="center" cellpadding="0" cellspacing="0" id="table14">
                  <tr>
                    <td width="632" valign="top"><img border="0" src="/inc/pics/contact_imgjp_03.gif" width="245" height="19"> <br>
                  ...
                  src="/inc/pics/contactimg01jp.gif" width="339" height="103"></TD>
                                  <TD vAlign=top><a title="New Chalon Hotel" href="mailto:services@newchalon.com"> <IMG height=103 
                  src="/inc/pics/contactimg02jp.gif" width=336 
              border=0></a></TD>
                                </TR>
                              </TBODY>
                            </TABLE>
                            ...
                            <table width="587" height="223" border="0" align="center" cellpadding="0" cellspacing="0" class="TD1" id="table18">
                              <tr>
                                <td width="69" height="21" valign="top" bgcolor="F3F3F3"><div align="center">氏&nbsp; 名</div></td>
                              ...
                              <tr>
                                <td width="69" height="21" valign="top" bgcolor="F3F3F3"><p align="center"> 電&nbsp; 話</td>
                                <td valign="top">　</td>
                              ...
                              <tr>
                                <td width="69" height="21" valign="top" bgcolor="F3F3F3"><div align="center">電子メール</div></td>
                                <td valign="top">　</td>
                              ...
                              <tr>
                                ...
                                <td valign="top"><div align="right">
                                    <input name="cmdok" type="submit"   value=" OK " class="put1" onclick="sendmsg()">
                                  &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input name="cmdcancel"  type="reset" value=" Cancel " class="put1" >
                                  &nbsp;&nbsp;&nbsp;</div></td>
                              </tr>
                            </table>
...
function sendmsg() {
	                    if($.trim($("#name").val())==''){alert('お名前を入力してください。');return false;}
	                    if($.trim($("#tel").val())==''){alert('お電話を入力してください。');return false;}
						if($.trim($("#email").val())=='' || !$("#email").val().match( /^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/ )){alert('正しいメールアドレスを入力してください。');return false;}
						if($.trim($("#content").val())==''){alert('伝言の内容を入力してください。');return false;}	
						
						
						$.post('/jp/ajax_feedback.php',{tel:$("#tel").val(),content:$("#content").val(),name:$("#name").val(),email:$("#email").val()},function(data) {
                               var myjson = '';eval('myjson=' + data + ';');
                               alert(myjson.info);
							   window.location.href='/jp/feedback.php?pageid=24';
                         });
                          ...
                          <tr>
                            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="/inc/pics/contact_img_07.gif" class="TD1" id="table21">
                                <tr>
                                  ...
                                  <td width="66%"> 住&nbsp;  所：上海市松江区梅家浜路1501号    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>                                    電&nbsp;  話: 0086-21-3777-3939 传真:0086-21-3777-3535<br>
