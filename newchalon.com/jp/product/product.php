<?php
require "../../inc/jp_product_core.php";
?>
...
<div class="maincontent">
    <div class="maincontentbox">
        ...
        <div class="rightcontent">
            ...
            <div class="abouttitlepic"><img src="/inc/pics/res_big_title_margaretjp.gif" width="690" height="36" border="0"></div>
		...
		for($i=0;$i<sizeof($arrproducts);$i++){?>
              <div class="plist" >
                  <div class="plisttop">
                  <a href="/jp/product/product.php?pdir=<?=$_GET[pdir]?>&pid=<?=$arrproducts[$i][id_prodinfo]?>"><img src="/upload/product/<?=getproductpic($arrproducts[$i][id_prodinfo])?>"></a>
                  </div>
