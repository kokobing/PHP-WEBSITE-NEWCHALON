            ...
            <div class="mainlefta"><img src="/inc/pics/sub3_res_01chi.gif" width="185"  border="0"></div>
            
            <div class="mainleftb">
                <ul>
                <?php for($i=0;$i<sizeof($arrprodslist);$i++){?>
                    <li><a href="/product/product.php?pdir=<?=$arrprodslist[$i][id_proddir]?>"><?=$arrprodslist[$i][name]?></a></li>
                <?php }?>
                </ul>
            </div>
